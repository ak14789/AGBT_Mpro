...
class MproDataLoader(DataLoader):
    ...
    """
    def __init__(self, data_dir, use_classification, train_rate, fpdata_dir, batch_size, shuffle, num_workers, **kwargs):
        self.data_dir = data_dir
        self.dataset = datasets.Mpro(data_dir, use_classification, **kwargs)  # 全集，npy和score等信息在子集里
